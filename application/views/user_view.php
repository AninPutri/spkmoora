                          ...
                          ?>
                                        ...
                                        <td>
                                         <div class="btn-group">
                                            ...
                                            <a href="<?php echo site_url('User/delete/').$key->id ?>" class="btn btn-danger" onClick="return confirm('Apakah Anda Yakin?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>   
                                         </div>
                                        </td>
                                    </tr>
                                <?php } ?>
